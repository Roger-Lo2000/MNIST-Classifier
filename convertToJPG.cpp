...
using namespace std;
using namespace cv;
// This is to convert all mnist data to image data format.
...
void readAndSave(const string& mnist_img_path, const string& mnist_label_path)
{
	...
	for (int i = 0; i != num_items; i++)
	{
		...
		string saveFile = "D:\\ML\\FullyConnectedNN\\train\\" + to_string((unsigned int)label) + "_" + to_string(i) + ".jpg";
...
int main()
{
	readAndSave("D:\\ML\\FullyConnectedNN\\t10k-images.idx3-ubyte", "D:\\ML\\FullyConnectedNN\\t10k-labels.idx1-ubyte");  
